...
export const productsApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        addRawMaterialToProduct: builder.mutation<void, { productId: number; materialId: number; quantity: number }>({
        ...
        removeRawMaterialFromProduct: builder.mutation<void, { productId: number; materialId: number }>({
        ...
        updateRawMaterialQuantity: builder.mutation<void, { productId: number; rawMaterialId: number; quantity: number }>({
        ...
        getMaxUnitsByProduct: builder.query<{ productId: number; maxUnits: number }, number>({
